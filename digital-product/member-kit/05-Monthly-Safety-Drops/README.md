...
1. Open the folder for the current month.
2. Read the `README.md` to understand the focus area.
...
## Do not skip old drops

If you are new to the membership, run the drops that cover your tech stack,
not just the current month's drop. The Stripe and Supabase drops are
relevant to any project using those tools.
